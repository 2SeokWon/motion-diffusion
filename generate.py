...
def generate():
    ...
    for i in range(args.num_samples):
        ...
        mean = np.concatenate([dataset.pos_vel_mean, dataset.position_mean, dataset.rotation_mean, dataset.foot_mean])
        std = np.concatenate([dataset.pos_vel_std, dataset.position_std, dataset.rotation_std, dataset.foot_std])
